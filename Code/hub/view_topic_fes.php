...
<html>
	...
	<?php include('common.php');?>
		<div id="content">
			...
			$sql="SELECT * FROM forum_question_fes WHERE id='$id'";
			$result=mysql_query($sql);

			$rows=mysql_fetch_array($result);
			?>
			<hr />
			<a href = "main_forum_fes.php">Back to Discussion</a>
			<hr />
			...
			$sql2="SELECT * FROM forum_answer_fes WHERE question_id='$id'";
			...
			<table width="400" border="0" cellpadding="0" cellspacing="1">
			<tr>
			<form name="form1" method="post" action="add_answer_fes.php">
			<td>
