...
<html>
	...
	<?php include('common.php');?>
		...
		<form method="post" action="delete_forum_fes.php">
			<?php
			...
			<tr>
			<caption><a href = "main_forum_fes.php">Festival Discussions</a></caption> 
			...
			<td><a href="view_topic_fes.php?id=<?php echo $rows['id']; ?>"><?php echo $rows['topic']; ?></a><BR></td>
			...
			<td colspan="3" align="right" bgcolor="#E6E6E6"><a href="create_topic_fes.php"><strong>Create New Topic</strong> </a></td>
