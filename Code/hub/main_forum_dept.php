...
<html>
	...
	<?php include('common.php');?>
		...
		<form method="post" action="delete_forum_dept.php">	
			<?php
			...
			<tr>
			<caption><a href = "main_forum_dept.php">Departmental Discussions</a></caption> 
			...
			<td><a href="view_topic_dept.php?id=<?php echo $rows['id']; ?>"><?php echo $rows['topic']; ?></a><BR></td>
			...
			<td colspan="3" align="right" bgcolor="#E6E6E6"><a href="create_topic_dept.php"><strong>Create New Topic</strong> </a></td>
