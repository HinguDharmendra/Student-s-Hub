	...
	<?php include('common.php');?>
		<div id="content">
			...
			if(empty($topic) || empty($detail))
			{
				...
				header('Refresh:3; URL=create_topic_dept.php');
				exit();
			}
			$name=$_SESSION['name'];
			...
			$sql="INSERT INTO forum_question_dept (topic, detail, name, email, datetime, dept)VALUES('".$topic."','".$detail."','".$name."','".$email."','".$datetime."','".$dept."')";
			$result=mysql_query($sql);
			if($result)
			{
				echo "Successful<BR>";
				header('Refresh:3; URL=main_forum_dept.php');
			}
			else 
			{
				echo "ERROR";
