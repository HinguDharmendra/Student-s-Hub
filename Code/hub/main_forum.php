...
<html>
	...
	<?php include('common.php');?>
		...
		<form method="post" action="delete_forum.php">
			<?php
			...
			<caption><a href = "main_forum.php">General Discussions</a></caption> 
			<tr>
			...
			<td colspan="3" align="right" bgcolor="#E6E6E6"><a href="create_topic.php"><strong>Create New Topic</strong> </a></td>
