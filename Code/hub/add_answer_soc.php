...
<html>
	...
	<?php include('common.php');?>
		<div id="content">
			...
			$tbl_name="forum_answer_soc"; // Table name
			...
			if(empty($a_answer))
			{
				...
				header("Refresh:3; URL=view_topic_soc.php?id=$id");
				exit();
			}
			...
			{
				echo "Successful<BR>";
				header("Refresh: 2; URL=view_topic_soc.php?id=$id");

				// If added new answer, add value +1 in reply column
				$tbl_name2="forum_question_soc";
